...
If You can auto Select Country , State, City just pass name in (currentCountry, currentState, currentCity) otherwise
            ...
            child: Column(
              children: [
                ...
                CSCPicker(
                  ...
                  ///If your want to Auto Fill Current Country , State, City, 
